...
public bool EntityAppear(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int entityID, bool bPublic, float px, float py, float pz)
{
	Nettention.Proud.Message __msg=new Nettention.Proud.Message();
		...
		__msg.Write(__msgid);
		Nettention.Proud.Marshaler.Write(__msg, entityID);
		Nettention.Proud.Marshaler.Write(__msg, bPublic);
...
public bool MoveToArray(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, System.Collections.Generic.List<int> entityID, System.Collections.Generic.List<float> px, System.Collections.Generic.List<float> py, System.Collections.Generic.List<float> pz)
{
	Nettention.Proud.Message __msg=new Nettention.Proud.Message();
		__msg.SimplePacketMode = core.IsSimplePacketMode();
		Nettention.Proud.RmiID __msgid= Common.MoveToArray;
		__msg.Write(__msgid);
		Nettention.Proud.Marshaler.Write(__msg, entityID);
		Nettention.Proud.Marshaler.Write(__msg, px);
		Nettention.Proud.Marshaler.Write(__msg, py);
	...
	return RmiSend(__list,rmiContext,__msg,
		RmiName_MoveToArray, Common.MoveToArray);
}

public bool MoveToArray(Nettention.Proud.HostID[] remotes,Nettention.Proud.RmiContext rmiContext, System.Collections.Generic.List<int> entityID, System.Collections.Generic.List<float> px, System.Collections.Generic.List<float> py, System.Collections.Generic.List<float> pz)
{
	Nettention.Proud.Message __msg=new Nettention.Proud.Message();
__msg.SimplePacketMode = core.IsSimplePacketMode();
Nettention.Proud.RmiID __msgid= Common.MoveToArray;
...
public bool CheckLatency(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, long prevTick)
{
	Nettention.Proud.Message __msg=new Nettention.Proud.Message();
		...
		__msg.Write(__msgid);
		Nettention.Proud.Marshaler.Write(__msg, prevTick);

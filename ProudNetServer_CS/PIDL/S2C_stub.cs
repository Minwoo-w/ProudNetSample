...
public BeforeRmiInvocationDelegate BeforeRmiInvocation = delegate(Nettention.Proud.BeforeRmiSummary summary) {};
		...
		public delegate bool MoveToArrayDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, System.Collections.Generic.List<int> entityID, System.Collections.Generic.List<float> px, System.Collections.Generic.List<float> py, System.Collections.Generic.List<float> pz);  
		public MoveToArrayDelegate MoveToArray = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, System.Collections.Generic.List<int> entityID, System.Collections.Generic.List<float> px, System.Collections.Generic.List<float> py, System.Collections.Generic.List<float> pz)
		{ 
			return false;
		};
	...
	public override bool ProcessReceivedMessage(Nettention.Proud.ReceivedMessage pa, Object hostTag) 
	{
        ...
        case Common.MoveTo:
            ...
            break;
        case Common.MoveToArray:
            ProcessReceivedMessage_MoveToArray(__msg, pa, hostTag, remote);
            break;
...
parameterString+=entityID.ToString()+",";
    ...
    void ProcessReceivedMessage_EntityAppear(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        ...
        int entityID; Nettention.Proud.Marshaler.Read(__msg,out entityID);	
bool bPublic; Nettention.Proud.Marshaler.Read(__msg,out bPublic);	
...
parameterString+=pz.ToString()+",";
    ...
    void ProcessReceivedMessage_MoveToArray(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        System.Collections.Generic.List<int> entityID; Nettention.Proud.Marshaler.Read(__msg,out entityID);	
System.Collections.Generic.List<float> px; Nettention.Proud.Marshaler.Read(__msg,out px);	
System.Collections.Generic.List<float> py; Nettention.Proud.Marshaler.Read(__msg,out py);	
System.Collections.Generic.List<float> pz; Nettention.Proud.Marshaler.Read(__msg,out pz);	
core.PostCheckReadMessage(__msg, RmiName_MoveToArray);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
        parameterString+=entityID.ToString()+",";
...
parameterString+=py.ToString()+",";
parameterString+=pz.ToString()+",";
        NotifyCallFromStub(Common.MoveToArray, RmiName_MoveToArray,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.MoveToArray;
        summary.rmiName = RmiName_MoveToArray;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =MoveToArray (remote,ctx , entityID, px, py, pz );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_MoveToArray);
        }
    ...
    void ProcessReceivedMessage_CheckLatency(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        ...
        long prevTick; Nettention.Proud.Marshaler.Read(__msg,out prevTick);	
...
public const string RmiName_MoveToArray="MoveToArray";
...
public const string RmiName_MoveToArray="";
